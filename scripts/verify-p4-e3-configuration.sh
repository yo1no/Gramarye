...
verify_lexical_helpers() {
    ...
    is_allowed_changed_path 'src/main/resources/META-INF/accesstransformer.cfg' \
        || fail 'P4-E3 self-test rejected the exact P8-S5 access-transformer path'
...
is_approved_p7_s2_changed_path() {
    case "$1" in
        ...
        src/test/java/com/yo1no/gramarye/magic/definition/store/P4D3AApiGateTest.java | \
        src/test/java/com/yo1no/gramarye/magic/network/P7S1BoundaryTest.java | \
        src/test/java/com/yo1no/gramarye/magic/network/CastIntentPayloadCodecTest.java | \
        src/test/java/com/yo1no/gramarye/magic/network/IntentAckPayloadCodecTest.java | \
        ...
        src/test/java/com/yo1no/gramarye/magic/network/PlayerManaSyncPayloadCodecTest.java | \
...
is_allowed_changed_path() {
    is_exact_p4e3_path "$1" \
        ...
        || is_approved_p8_s4_production_path "$1" \
        || is_approved_p8_s3_test_changed_path "$1" \
        || is_approved_p8_s4_test_path "$1" \
        || is_approved_p8_s5_production_path "$1" \
        || is_approved_p8_s5_resource_path "$1" \
        || is_approved_p8_s5_test_path "$1"
}
