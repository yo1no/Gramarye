...
final class PresentationLimits {
    ...
    static final int MAX_PROFILE_TYPES = 64;
    static final int MAX_PROFILE_INSTANCES_PER_CHANNEL = 64;
    static final int MAX_PROFILE_INSTANCES = 192;
    static final int MAX_PROFILE_DISCOVERED_RESOURCES = 256;
    static final int MAX_PROFILE_RAW_SOURCE_BYTES = 16_384;
    static final int MAX_PROFILE_INSPECTED_SOURCE_BYTES = 16_385;
    static final long MAX_PROFILE_ACCEPTED_RELOAD_BYTES = 4_194_304L;
    static final long MAX_PROFILE_INSPECTED_RELOAD_BYTES = 4_194_560L;
    static final int MAX_PROFILE_JSON_DEPTH = 12;
    static final int MAX_PROFILE_JSON_NODES_PER_ENTRY = 256;
    static final long MAX_PROFILE_JSON_NODES_PER_RELOAD = 65_536L;
    static final int MAX_PROFILE_CONFIGURATION_VERSION = 65_535;
    static final int MIN_PROFILE_ENVELOPE_BYTES = 3;
