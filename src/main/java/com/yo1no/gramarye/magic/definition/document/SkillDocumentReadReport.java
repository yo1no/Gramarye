...
/** Non-persistent facts about tolerant normalization of a formal document. */
public record SkillDocumentReadReport(List<ReadFact> facts, boolean truncated) {
    public SkillDocumentReadReport {
